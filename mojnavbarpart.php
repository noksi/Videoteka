<div class="mojnavbar">
    ...
    <form class="mojnavbarforma" method="POST" action="search.php">
        ...
        <select class="form-control3" name="slova" style="width: 23%;">
    ...
    <form class="mojnavbarforma" method="POST" action="search.php">
        <div class="navbar-title navbar-title2" style="margin-left: 2%">Upišite naziv filma:</div> 
...
<div class="mojnavbar2">
    ...
    <form class="mojnavbarforma2" method="POST" action="search.php">
        <div class="navbar-title navbar-title2" style="margin-left: 2%">Upišite godinu izdavanja:</div> 

        <input type="number" name="godina" placeholder="Godina izdavanja filma" class="form-control3" style="width: 31.5%;">
