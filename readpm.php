                ...
                <div class="tablahead">
                    <form method="POST" action="php/deletepmid.php">
                        <ul class="pm" style="width:100%">
                            ...
                            <a href="reply.php" class="glyphicon glyphicon-share-alt pmglifreply" title="Odgovori na poruku"></a>
                            ...
                            while ($rowpm = mysqli_fetch_assoc($resultpm)) {
                                $_SESSION['receiver']=$rowpm['username'];
                                $_SESSION['title']=$rowpm['titlemsg'];
                                ?>
