...
<div class="korisni2">
    ...
    <form method="POST" action="process.php" class="signup">
        <span style="color: #9d9d9d !important;"><strong>PRIJAVI SE</strong></span>
        <div class="flexuserlogin">
        <span style="color: #222 !important;"><strong>Korisničko ime:</strong></span><br>
        <input class="form-control2" type="text" name="username"><br>
        <span style="color: #222 !important;"><strong>Lozinka:</strong></span><br>
        <input class="form-control2" type="password" name="password">
        <br><br>
        <input type="submit" name="submit" class="btn btn-default butoni" value="Prijavi se" >
